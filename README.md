...
Abstract
The Akimov Theory of Unity (ToU) proposes that consciousness is not an intrinsic property of a system, but an emergent stable attractor arising from the interaction between a system’s internal world-model (M_w) and self-model (M_s). This work introduces a formal conceptual framework for perspectival organization in complex systems.
...
🔬 Research Status
SSubmission-ready academic manuscript. Currently under review/submission to arXiv.

📄 Citation / DOI
This work is publicly archived and citable via Zenodo:

Latest version (v1.5): DOI: https://doi.org/10.5281/zenodo.19207652

All versions DOI: https://doi.org/10.5281/zenodo.19141780

📥 Official Submission PDF
Final official submission version:

Download the final PDF (EN, v1.5)
